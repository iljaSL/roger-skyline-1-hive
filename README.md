<h3>Roger-Skyline-1 is the second project in the network & system administration branch at Hive Helsinki in which I learned how to use different kind of services used on a server machine and how to secure the server properly.</h3>
